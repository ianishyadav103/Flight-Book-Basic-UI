...
SECRET_KEY = 'django-insecure-ly&*74c#4ke3z20udyolj5dqh0b3-qibs6w3%45_nwtvcm5!&)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['iavnishyadav07.pythonanywhere.com']
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'bookin_api.apps.BookinApiConfig'
]
